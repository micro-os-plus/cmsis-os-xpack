...
- name the file like `2020-12-19-cmsis-os-xpack-v0-1-0-released.md`
- name the post like: **µOS++ cmsis-os-xpack v0.1.0 released**
...
- `npm dist-tag add @micro-os-plus/cmsis-os-xpack@0.1.0 latest`
- `npm dist-tag ls @@micro-os-plus/cmsis-os-xpack`
...
- paste the release name like **µOS++ cmsis-os-xpack v0.1.0 released**
