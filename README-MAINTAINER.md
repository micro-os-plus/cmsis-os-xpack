...
- name the post like: **µOS++ cmsis-os-xpack v2.0.0 released**
...
- `npm dist-tag add @micro-os-plus/cmsis-os-xpack@2.0.0 latest`
- `npm dist-tag ls @@micro-os-plus/cmsis-os-xpack`
...
- paste the release name like **µOS++ cmsis-os-xpack v2.0.0 released**
